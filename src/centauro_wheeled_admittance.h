...
namespace XBot { namespace Cartesian {
    ...
    class CentauroWheeledAdmittance : public CartesianInterfaceImpl
    {

    public:

        CentauroWheeledAdmittance(ModelInterface::Ptr model);
        ...
        virtual ~CentauroWheeledAdmittance();
    ...
    private:
        ...
        typedef OpenSoT::tasks::velocity::CartesianAdmittance AdmittanceTask;
        ...
        Utils::ForceEstimation::Ptr _force_est;
